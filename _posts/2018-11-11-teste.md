...
1. In order to try to buy one chocolate bar you need to spend $$\Delta m$$. 

2. You can't choose the chocolate bar. You can only pick one randomly in each time step and 
if that bar was already choosed before, by you or by your oppend you lose your $$\Delta m$$.
